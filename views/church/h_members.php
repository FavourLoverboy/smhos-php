    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <?php
                ...
                $tblquery = "SELECT COUNT(members.id) AS mebs, homecells.name FROM members INNER JOIN homecells ON members.homecell_id = homecells.id WHERE homecells.church_id = :c GROUP BY members.homecell_id ORDER BY mebs DESC, name LIMIT 5";
                $tblvalue = array(
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <?php
                ...
                $tblquery = "SELECT COUNT(members.id) AS mebs, homecells.name FROM members INNER JOIN homecells ON members.homecell_id = homecells.id WHERE homecells.church_id = :c GROUP BY members.homecell_id ORDER BY mebs, name LIMIT 5";
                $tblvalue = array(
                    ':c' => $_SESSION['church_id']
                );
                $select = $connect->tbl_select($tblquery, $tblvalue);
