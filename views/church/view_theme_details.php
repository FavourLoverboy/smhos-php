                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                ...
                                $tblquery = "SELECT members.last_name, members.first_name, members.other_name, attendance.h_id, attendance.date FROM members INNER JOIN attendance ON members.id = attendance.user WHERE attendance.h_id != '' AND attendance.theme_id = :theme_id AND attendance.c_id = :church_id ORDER BY attendance.id";
                                $tblvalue = array(
