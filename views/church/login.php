...
<div class="container-fluid pt-5">
    ...
    <?php 
        ...
        $tblquery = "SELECT COUNT(login) AS login FROM members WHERE login != '' AND church_id = :c";
        $tblvalue = array(
        ...
        $tblquery = "SELECT COUNT(login) AS n FROM members WHERE login = '' AND church_id = :c";
        $tblvalue = array(
            ':c' => $_SESSION['church_id']
        );
        $select = $connect->tbl_select($tblquery, $tblvalue);
