    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <?php
                ...
                $tblquery = "SELECT COUNT(members.id) AS mebs, churches.name FROM members INNER JOIN churches ON members.church_id = churches.id GROUP BY members.church_id ORDER BY mebs DESC, name LIMIT 5";
                $tblvalue = array();
