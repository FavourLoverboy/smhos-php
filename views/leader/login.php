...
<div class="container-fluid pt-5">
    ...
    <?php 
        ...
        $tblquery = "SELECT COUNT(login) AS login FROM members WHERE login != '' AND homecell_id = :h";
        $tblvalue = array(
        ...
        $tblquery = "SELECT COUNT(login) AS n FROM members WHERE login = '' AND homecell_id = :h";
        $tblvalue = array(
            ':h' => $_SESSION['homecell_id']
        );
        $select = $connect->tbl_select($tblquery, $tblvalue);
