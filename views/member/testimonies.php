                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                ...
                                $tblquery = "SELECT members.last_name, members.first_name, members.other_name, members.email, members.number, members.sex, members.profile, testimonies.id as ids, testimonies.content, testimonies.date, testimonies.status FROM members INNER JOIN testimonies ON members.id = testimonies.user WHERE testimonies.status = '1' ORDER BY testimonies.id DESC";
                                $tblvalue = array();
