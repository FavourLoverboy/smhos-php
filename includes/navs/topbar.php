...
<nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            <div class="navbar-toggle" onclick="sideBar()">
        ...
        <div class="collapse navbar-collapse justify-content-end bg-white" id="navigation">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link btn-magnify" href="javascript:;">
                        <i class="fa fa-envelope" aria-hidden="true"></i>
                        <p>
                            <span class="d-lg-none d-md-block" style="text-transform:lowercase;"><?php echo $_SESSION['email']; ?></span>
                        </p>
                    </a>
                </li>
                ...
                <li class="nav-item profile-pics">
